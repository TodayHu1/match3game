...
class GeneratRandomUnit {
    ...
    init(playerLvl: Int) {
        ...
        unitSpell = (unitPower / (gameScene.random(number: 10) + 1)) + 1
        ...
        unitNumberArmor = gameScene.random(number: lroundf(Float(unitStat/2)))*10
...
//        print("\(unitSpell) -- Магия юнита")
    ...
    func generate() -> EnemyUnit {
        echo()
        unit = EnemyUnit(enemyName: "RandomTestUnit", attack: unitNumberAttack, health: unitNumberHealth+999, shield: unitNumberArmor,
